...
app.post('/api/communication/send', (req, res) => {
  ...
  const userMsg = { id: Date.now(), sender: 'user', text: text, user: user.identifier };
  db.messages.push(userMsg);

  const adminMsg = {
    id: Date.now() + 1, sender: 'admin',
    text: 'We have received your message. Our team is on it!'
  };
